...
#   * its `original` arm is NOT refitted -- it reads the 25 fitted objects
#     straight out of dd_output.RData, and those objects are now the TUNED
#     models. The original-vs-revised contrast would compare the tuned arm
#     against itself.
#
