LO -- residual autocorrelation: how to read these files
generated 2026-09-19 05:30

PROVENANCE (regenerate this folder whenever the models are refitted)
  species/model set : DuskyDolphin
  models diagnosed  : lo.dsm.xy.fsyear.season, lo.dsm.xy.fsyear.season.depth, lo.dsm.xy.byyear.season.depth
  segments (n)      : 6288
  soap interior knots: 40
  soap boundary      : simplify_tol 3000 / margin 2000

FILES
  LO_autocorrelation_summary.csv  one row per model x scale -- start here
  LO_dsm_correlogram.csv          every lag, the underlying numbers
  LO_dsm_correlogram.png          the same thing as a figure
